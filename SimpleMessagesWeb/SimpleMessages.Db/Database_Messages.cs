...
{
    // TODO: these methods are obsolete!!! Rewrite callers to use generic procedure calls!!! (see: Database.cs)
    public partial class Database
    {
        public Message[] GetMessages(string to, MessageStatusType lastStatus, bool showDeleted = false)
        {
        ...
        public Notification[] GetNotifications(string to)
        {
            using (SqlConnection conn = new SqlConnection())
            {
                var cmd = conn.CreateCommand();
                ...
                try
                {
                    ...
                    while (reader.Read())
                    {
                        notifications.Add(new Notification
                        {
                            ...
                            ForUser = reader["ForName"].ToString(),
        ...
        //public Guid CreateMessage(Message message)
        //{
        //    using (SqlConnection conn = new SqlConnection())
        //    {
        //        var cmd = conn.CreateCommand();
        ...
        public bool DeleteMessage(Guid guid)
        {
            using (SqlConnection conn = new SqlConnection())
            {
                var cmd = conn.CreateCommand();
        ...
        public Guid[] DeleteMessages(string from, string to, DateTime? timeFrom, DateTime? timeTo)
        {
            using (SqlConnection conn = new SqlConnection())
            {
                var cmd = conn.CreateCommand();
        ...
        public bool SetMessageStatus(Guid guid, MessageStatusType newStatus)
        {
            using (SqlConnection conn = new SqlConnection())
            {
                var cmd = conn.CreateCommand();
        ...
        public Guid[] SetMessageStatus(string fromName, string toName, MessageStatusType newStatus)
        {
            using (SqlConnection conn = new SqlConnection())
            {
                var cmd = conn.CreateCommand();
        ...
        public bool UpdateMessageContent(Guid guid, string content)
        {
            using (SqlConnection conn = new SqlConnection())
            {
                var cmd = conn.CreateCommand();
        ...
        public Message[] FindMessages(string from, string to, DateTime? timeFrom, DateTime? timeTo, string searchText, bool includeDeleted)
        {
