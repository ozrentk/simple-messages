...
namespace SimpleMessages.Svc.Extensions
{
    public class DispatchLogger : IEndpointBehavior, IDispatchMessageInspector
    {
        ...
        public object AfterReceiveRequest(ref Message request, IClientChannel channel, InstanceContext instanceContext)
        {
            ...
            if (!propDict.ContainsKey("httpRequest") ||
                !propDict.ContainsKey("UriTemplateMatchResults") ||
                !propDict.ContainsKey("HttpOperationName"))
                return null;
        ...
        public void BeforeSendReply(ref Message reply, object correlationState)
        {
            ...
            if (!propDict.ContainsKey("httpResponse"))
                return;
            ...
            // TODO: find a proper way to capture outgoing data
            //if (!reply.IsEmpty)
            //{
            //    // Copy response body
